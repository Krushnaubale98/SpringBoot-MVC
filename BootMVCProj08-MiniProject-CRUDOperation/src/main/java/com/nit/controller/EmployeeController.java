...
public class EmployeeController {
	...
	@PostMapping("/insert_employee")
	String insertEmployee(RedirectAttributes attrs, @ModelAttribute("emp") Employee emp) {
	...
	@PostMapping("edit_employee")
	public String eidtEmployee(RedirectAttributes attrs, @ModelAttribute("emp") Employee emp) {
